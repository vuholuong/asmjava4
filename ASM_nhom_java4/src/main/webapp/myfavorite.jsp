...
<body data-bs-spy="scroll" data-bs-target="#navbar-example2"
	...
	<section id="residence">
		<div class="container mt-5 py-5">
			<h2 class="text-center mt-5">Danh Sách Video Yêu Thích</h2>

			<!-- Hiển thị thông báo nếu danh sách yêu thích trống -->
			<c:if test="${empty favoriteVideos}">
				<div class="alert alert-info text-center" role="alert">Bạn
					chưa có video yêu thích nào.</div>
			</c:if>
				...
				<c:forEach items="${favoriteVideos}" var="video">
					<div class="col-sm-4">
						<div class="card m-3 shadow-sm">
							<a href="videoDetail?id=${video.id}"> 
							<iframe class="card-img-top" width="450px" height="350px"
								src="${video.poster}" title="${video.title}" 
							...
							<div class="card-footer d-flex justify-content-between">
								<!-- Nút Dislike -->
								<form action="DiskLike" method="post" class="btn-danger">
								...
								<span> <a href="#"
											...
											onclick="openShareModal('${video.id}', '${video.title}')">
												<i class="bi bi-share"></i> Share</a>
								</span>

								<!-- Views -->
								<span>${video.views} <i class="bi bi-eye"></i>
								</span>
							</div>
						</div>
					</div>
...
<!-- Modal Share -->
<div class="modal fade mt-5 py-5" id="shareModal" tabindex="-1" aria-labelledby="shareModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="shareForm" action="ShareServlet" method="post">
                    ...
                    <div class="mb-3">
                        <input type="email" placeholder="Nhập email muốn share" class="form-control" id="email" name="email" required>
                    </div>
                    <div class="mb-3">
