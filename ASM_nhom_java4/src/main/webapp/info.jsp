...
<body data-bs-spy="scroll" data-bs-target="#navbar-example2"
	...
	<div class="container mt-5 py-5 ">
		...
		<form action="updateUser" method="post" class="shadow-lg p-4 rounded">
			<div class="mb-3">
				<label for="userId" class="form-label">Email</label> 
				<input type="text" class="form-control" id="userId" name="email" value="${user.email}" readonly />
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<select class="form-select" id="userRole" name="role">
					...
					<option value="moderator" ${user.admin == 'moderator' ? 'selected' : ''}>Moderator</option>
				</select>
			</div>
